/**
 * Simulated AI coding-agent CLI session renderer.
 * Reuses the same text-scroll pattern as Terminal.js.
 */
export default {
  name: 'ActivityAiAgent',
  ...
  template: `
    <div class="activity-ai-agent text-scroll" ref="containerRef">
      <div
